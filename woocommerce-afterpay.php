...
function woocommerce_afterpay_init() {
	...
	class WC_Gateway_Afterpay extends WC_Payment_Gateway {
		...
		function check_pending_abandoned_orders() {
			...
			$onhold_orders = get_posts(array('post_type'=>'shop_order','post_status'=>'wc-on-hold','numberposts'=>-1));
			...
			$pending_orders = get_posts(array('post_type'=>'shop_order','post_status'=>'wc-pending','numberposts'=>-1));
